...
class ADCGetCredentialsAppEngineTest extends BaseTest {
    ...
    public function testAppEngineStandard() {
        ...
        $this->assertInstanceOf(
                'Google\Auth\Credentials\AppIdentityCredentials', ApplicationDefaultCredentials::getCredentials()
        );
    }
    ...
    public function testAppEngineFlexible() {
        ...
        $this->assertInstanceOf(
                'Google\Auth\Credentials\GCECredentials', ApplicationDefaultCredentials::getCredentials(null, $httpHandler)
        );
    }
}
