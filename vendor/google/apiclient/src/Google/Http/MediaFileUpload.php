...
class Google_Http_MediaFileUpload {
    ...
    Google_Client $client, RequestInterface $request, $mimeType, $data, $resumable = false, $chunkSize = false
    ) {
        $this->client    = $client;
    ...
    public function nextChunk($chunk = false) {
        ...
        $request = new Request(
                'PUT', $resumeUri, $headers, Psr7\stream_for($chunk)
        );
