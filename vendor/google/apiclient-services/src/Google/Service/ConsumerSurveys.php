...
class Google_Service_ConsumerSurveys extends Google_Service {
    ...
    const CONSUMERSURVEYS          = "https://www.googleapis.com/auth/consumersurveys";
    /** View the results for your surveys. */
    const CONSUMERSURVEYS_READONLY = "https://www.googleapis.com/auth/consumersurveys.readonly";
    ...
    public function __construct(Google_Client $client) {
        ...
        $this->mobileapppanels = new Google_Service_ConsumerSurveys_Resource_Mobileapppanels(
                $this, $this->serviceName, 'mobileapppanels', array(
            'methods' => array(
                'get'    => array(
        ...
        $this->results         = new Google_Service_ConsumerSurveys_Resource_Results(
                $this, $this->serviceName, 'results', array(
            'methods' => array(
                'get' => array(
        ...
        $this->surveys         = new Google_Service_ConsumerSurveys_Resource_Surveys(
                $this, $this->serviceName, 'surveys', array(
            'methods' => array(
                'delete' => array(
