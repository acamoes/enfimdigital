...
class Google_Service_DLP extends Google_Service {
    ...
    public function __construct(Google_Client $client) {
        ...
        $this->infoTypes                         = new Google_Service_DLP_Resource_InfoTypes(
                $this, $this->serviceName, 'infoTypes', array(
            'methods' => array(
                'list' => array(
        ...
        $this->organizations_deidentifyTemplates = new Google_Service_DLP_Resource_OrganizationsDeidentifyTemplates(
                $this, $this->serviceName, 'deidentifyTemplates', array(
            'methods' => array(
                'create' => array(
        ...
        $this->organizations_inspectTemplates    = new Google_Service_DLP_Resource_OrganizationsInspectTemplates(
                $this, $this->serviceName, 'inspectTemplates', array(
            'methods' => array(
                'create' => array(
        ...
        $this->projects_content                  = new Google_Service_DLP_Resource_ProjectsContent(
                $this, $this->serviceName, 'content', array(
            'methods' => array(
                'deidentify' => array(
        ...
        $this->projects_dataSource               = new Google_Service_DLP_Resource_ProjectsDataSource(
                $this, $this->serviceName, 'dataSource', array(
            'methods' => array(
                'analyze' => array(
        ...
        $this->projects_dlpJobs                  = new Google_Service_DLP_Resource_ProjectsDlpJobs(
                $this, $this->serviceName, 'dlpJobs', array(
            'methods' => array(
                'cancel' => array(
        ...
        $this->projects_image                    = new Google_Service_DLP_Resource_ProjectsImage(
                $this, $this->serviceName, 'image', array(
            'methods' => array(
                'redact' => array(
