...
class Smarty_Internal_Templatelexer {
    ...
    public function yypushstate($state) {
        if ($this->yyTraceFILE) {
            fprintf($this->yyTraceFILE, "%sState push %s\n", $this->yyTracePrompt, isset($this->state_name[$this->_yy_state]) ? $this->state_name[$this->_yy_state] :
                            $this->_yy_state);
        }
    ...
    public function yylex1() {
        if (!isset($this->yy_global_pattern1)) {
            $this->yy_global_pattern1 = "/\G([{][}])|\G(" . $this->ldel . "[*])|\G((" . $this->ldel . "\\s*php([ ].*?)?" . $this->rdel . ")|(" .
...
// end function
    ...
    public function yylex2() {
        if (!isset($this->yy_global_pattern2)) {
            $this->yy_global_pattern2 = "/\G(" . $this->ldel . "\\s*(if|elseif|else if|while)\\s+)|\G(" . $this->ldel . "\\s*for\\s+)|\G(" .
...
// end function
    ...
    public function yylex4() {
        if (!isset($this->yy_global_pattern4)) {
            $this->yy_global_pattern4 = "/\G(" . $this->ldel . "\\s*literal\\s*" . $this->rdel . ")|\G(" . $this->ldel . "\\s*[\/]literal\\s*" .
                    $this->rdel . ")|\G([\S\s])/isS";
        }
        if (!isset($this->dataLength)) {
            $this->dataLength = strlen($this->data);
...
// end function
    ...
    public function yylex5() {
        if (!isset($this->yy_global_pattern5)) {
            $this->yy_global_pattern5 = "/\G(" . $this->ldel . "\\s*literal\\s*" . $this->rdel . ")|\G(" . $this->ldel . "\\s*[\/]literal\\s*" .
