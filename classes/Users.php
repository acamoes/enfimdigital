...
/*
    ...
    function getMyAgenda() {
        $query = "SELECT ct.idCourses as ctIdCourses,ct.idUsers as ctIdUsers,ct.type as ctType," .
                "cs.idCourses as csIdCourses,cs.year as csYear,cs.course as csCourse,cs.completeName as csCompleteName,cs.startDate as csStartDate,cs.endDate as csEndDate,cs.local as csLocal,cs.vacancy as csVacancy,cs.idCourse as csIdCourse,cs.internship as csInternship,cs.status as csStatus,cs.observations as csObservations," .
