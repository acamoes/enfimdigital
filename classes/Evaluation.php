                ...
                for ($j = 0, $sc = count($this->template->avaliacao->itens[$i]->itens); $j < $sc; $j++) {
                    ...
                    if ($this->template->avaliacao->itens[$i]->itens[$j]->tema != 'name') {
                        ...
                        if (property_exists(
                            ...
                            if ($this->template->avaliacao->itens[$i]->itens[$j]->pontos_positivos->tipo
                                == 'longText') {
                                $html .= $this->textArea(
                        ...
                        if (property_exists(
                            ...
                            if ($this->template->avaliacao->itens[$i]->itens[$j]->pontos_a_melhorar->tipo
                                == 'longText') {
                                $html .= $this->textArea(
                        ...
                        if (property_exists(
                            ...
                            if ($this->template->avaliacao->itens[$i]->itens[$j]->recomendacoes->tipo
                                == 'longText') {
                                $html .= $this->textArea(
                        ...
                        if ($this->template->avaliacao->itens[$i]->tema == 'Formadores') {
                            ...
                            for ($k = 0, $f = count($listaFormadores); $k < $f; $k++) {
                                ...
                                $formador['firstLastName'] = $parts[0].' '.$parts[count($parts)
                                    - 1];
                                $html                      .= "<br/>";
                                ...
                                foreach ($temas as $temas) {
                                    ...
                                    if (property_exists(
                                        ...
                                        if ($this->template->avaliacao->itens[$i]->itens[$j]->pontos_positivos->tipo
                                            == 'longText') {
                                            $html .= $this->textArea(
                                                'formador-pontos_positivos-'.$temas.'-'.$formador['idUsers'],
                                                $temas,
                                                $this->template->avaliacao->itens[$i]->itens[$j]->pontos_positivos->intervalo,
                                                (
                                    ...
                                    if (property_exists(
                                        ...
                                        if ($this->template->avaliacao->itens[$i]->itens[$j]->pontos_a_melhorar->tipo
                                            == 'longText') {
                                            $html .= $this->textArea(
                                                'formador-pontos_a_melhorar-'.$temas.'-'.$formador['idUsers'],
                                                $temas,
                                                $this->template->avaliacao->itens[$i]->itens[$j]->pontos_a_melhorar->intervalo,
                                                (
                                    ...
                                    if (property_exists(
                                        ...
                                        if ($this->template->avaliacao->itens[$i]->itens[$j]->recomendacoes->tipo
                                            == 'longText') {
                                            $html .= $this->textArea(
                                                'formador-recomendacoes-'.$temas.'-'.$formador['idUsers'],
                                                $temas,
                                                $this->template->avaliacao->itens[$i]->itens[$j]->recomendacoes->intervalo,
                                                (
                ...
                for ($j = 0, $sc = count($this->template->avaliacao->itens[$i]->itens); $j
                    ...
                    if ($this->template->avaliacao->itens[$i]->itens[$j]->tema != 'name') {
                        if (property_exists(
                            ...
                            $this->template->avaliacao->itens[$i]->itens[$j]->avaliacao->response
                                = ($responses[ENFIM::cleanString($this->template->avaliacao->itens[$i]->itens[$j]->tema.'-avaliacao')]
                                    ?? "");
                        }
                        if (property_exists($this->template->avaliacao->itens[$i]->itens[$j],
                                'pontos_positivos')) {
                            $this->template->avaliacao->itens[$i]->itens[$j]->pontos_positivos->response
                                = ($responses[ENFIM::cleanString($this->template->avaliacao->itens[$i]->itens[$j]->tema.'-pontos_positivos')]
                                    ?? "");
                        }
                        if (property_exists($this->template->avaliacao->itens[$i]->itens[$j],
                                'pontos_a_melhorar')) {
                            $this->template->avaliacao->itens[$i]->itens[$j]->pontos_a_melhorar->response
                                = ($responses[ENFIM::cleanString($this->template->avaliacao->itens[$i]->itens[$j]->tema.'-pontos_a_melhorar')]
                                    ?? "");
                        }
                        if (property_exists($this->template->avaliacao->itens[$i]->itens[$j],
                                'recomendacoes')) {
                            $this->template->avaliacao->itens[$i]->itens[$j]->recomendacoes->response
                                = ($responses[ENFIM::cleanString($this->template->avaliacao->itens[$i]->itens[$j]->tema.'-recomendacoes')]
                                    ?? "");
                        }
                    } else {
                        if ($this->template->avaliacao->itens[$i]->tema == 'Formadores') {
