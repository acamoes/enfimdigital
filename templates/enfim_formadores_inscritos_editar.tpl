            ...
            <div class="content">
                ...
                <section>
                    ...
                    <form id="{$currentTab}Atualizar" name="{$currentTab}Atualizar"
                        ...
                        <div class="row uniform">
                            <div style="float: left">
                                <label for="sigla">Sigla</label><input type="text" name="sigla" readonly
                                                                       id="sigla" maxlength="3" style="width: 100px"
                                                                       value="{$utilizador['sigla']}"
                                                                       {literal}pattern="[A-Z]{2,3}$" />{/literal}
                            </div>
                            <div style="float: right">
                                <label for="name">Nome</label><input readonly type="text"
                        ...
                        <div class="row uniform">
                            <div style="float: left">
                                <label for="permission">Nível</label> <select name="permission" readonly
