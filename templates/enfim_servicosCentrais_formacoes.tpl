<section id="wrapper">
    <div class="wrapper">
            ...
            <div class="row uniform" style="width: 100%">
                <div style="float: left; margin-left: -1em">
                    ...
                    <select name="{$action}{$currentTab}IdCourse"
                        ...
                        {foreach $servicosCentrais->calendarios as $calendarios}
                            <option 
        ...
        <section id="subSubForm" style="width: 100%;">
            {if isset($servicosCentraisFormacoesIdCourse)}
                {include file="enfim_servicosCentrais_formacoes_contexto.tpl"}
            {/if}
        </section>
    </div>	
</section>
