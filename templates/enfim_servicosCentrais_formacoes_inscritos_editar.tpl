                                            ...
                                            datastring.push({ldelim}name: 'tab', value: '{$currentTab}'});
                                                    datastring.push({ldelim}name: 'subTab', value: '{$currentSubTab}'});
                                                            datastring.push({ldelim}name: 'idUsers', value: '{$utilizador['idUsers']}'});
                                                                    datastring.push({ldelim}name: 'idCourses', value: '{$servicosCentraisFormacoesIdCourses}'});
                                                                            $.ajax({
                                                                                url: '{$SCRIPT_NAME}',
                                                                                data: datastring,
                            ...
                            <div style="float: left">
                                ...
                                <div style="float: right">
                                    ...
                                    <ul class="actions" onclick="
                                        ...
                                        {ldelim}
                                                    requestAPI('action={$action}&task=getEAEP&idCourses={$servicosCentraisFormacoesIdCourses}&tab={$currentTab}&tab={$currentSubTab}&aepId=' + document.getElementById('aepId').value, 'formMsg');
                                                }"
                                        style="float: right">
