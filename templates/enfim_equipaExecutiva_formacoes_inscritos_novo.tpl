                        ...
                        <div class="row uniform">
                            <div style="float: left">
                                ...
                                <input type="text"
                                       ...
                                       onclick="request('action={$action}&task=novo&tab={$currentTab}&subTab={$currentSubTab}&idCourses='+document.getElementById('idCourses').value+'&searchUtilizadores=' + document.getElementById('searchUtilizadores').value, 'resultadoInscritos');"></a>
                                
                            </div>
                        </div>
                        <div class="row uniform">
                            <div style="float: Left" id="resultadoInscritos"></div>
                        </div>
                    </form>
                </section>
            </div>
