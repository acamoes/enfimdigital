                ...
                <section>
                    ...
                    <form id="{$currentTab}{$currentSubTab}Atualizar" name="{$currentTab}{$currentSubTab}Atualizar"
                        ...
                        <div class="row uniform">
                            <div id="formMsg"></div>
                            <input type="hidden" name="idCourses" id="idCourses" value="{$equipaExecutivaFormacoesIdCourses}" /> 
                        ...
                        <div class="row uniform">
                            <div style="float: left">
                                ...
                                <textarea cols="5" rows="3" name="observations" id="observations" style="width: 630px">{$ficheiros['observations']|urldecode}</textarea>
                            </div>
                        </div>
